...
Subscription Members::getSubscription()
{
...
void Members::WorkoutHistory( unordered_map<int, ClassSessions>& allClasses)
{
...
{  
   int choice = 0; // Initialize choice to avoid bypassing initialization  
   do {  
       cout << "Member menu:" << endl;
       cout << "----------------------------------------------------" << endl;
       cout << "1- View Subscription.\n 2- Book a Padel Court.\n 3- Cancel Padel Court.\n 4- Track Workout History.\n 5- Join class.\n 6- Cancel class.\n 7- Exit";  
       cin >> choice;  
       switch (choice) {  
       case 1:  
